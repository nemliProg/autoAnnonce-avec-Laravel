<template>
  <div class="container">
    <div class="layer" @click="toggleEdit"></div>
    <div class="popup">
      <div class="form">
        <div class="signup-form">
          <div class="heading">update <b>Offer</b></div>
          <div class="input-box">
            <form @submit.prevent="updateOffer">
              ...
              <input
                ...
                required
              />
              <input type="submit" class="submit" value="update Offer" />
            </form>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    updateOffer(id) {
      ...
      axios
        .post(`http://tonbook.io/api/offer/${this.id}`, fd, config)
        .then((response) => {
          let data = response.data
          this.$store.state.offers.map(o => {
            if (o.id == this.id) {
              o.book_title = data.book_title
              o.book_category = data.book_category
